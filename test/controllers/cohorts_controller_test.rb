...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { begin_date: @cohort.begin_date, comments: @cohort.comments, end_date: @cohort.end_date, is_active: @cohort.is_active, name: @cohort.name } }
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { begin_date: @cohort.begin_date, comments: @cohort.comments, end_date: @cohort.end_date, is_active: @cohort.is_active, name: @cohort.name } }
